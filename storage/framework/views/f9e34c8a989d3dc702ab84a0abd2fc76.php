...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between">
            ...
            <a href="<?php echo e(route('permission.create')); ?> " class="bg-slate-700 text-sm rounded-md  text-white px-3 py-3" style="text-decoration: btn " >Create</a>
        </div>
            ...
            <tbody class="bg-white">
                <?php if($permissions->isNotEmpty()): ?>
                 ...
                 <tr class="border-b">
                    ...
                    <td class="px-6 py-3 text-left"><?php echo e(\Carbon\Carbon::parse($permission->created_at) ->format('d M, Y')); ?></td>
                    <td class="px-6 py-3 text-center"> 
                         <a href="javascript:void(0);"onclick ="deletePermission(<?php echo e($permission->id); ?>)" class="bg-red-600 text-sm rounded-md text-white px-3 py-3 hover:bg-red-500" >Delete</a>
                  </td>
                </tr> 
    ...
    <script type="text/javascript"> 
        function deletePermission(id) {
            if (confirm('Are you sure you want to delete?')) {
                $.ajax({
                    url: '<?php echo e(route("permissions.destroy", ":id")); ?>'.replace(':id', id),
                    type: 'DELETE',
                    dataType: 'json',
                    data: {
                    ...
                    success: function(response) {
                        window.location.href = '<?php echo e(route("permission.index")); ?>';
                    },
                    error: function(xhr) {
...
<?php endif; ?>
<?php /**PATH C:\Users\ACI\Desktop\role\Role and permission\resources\views/permission/list.blade.php ENDPATH**/ ?>