...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between">
            ...
            <a href="<?php echo e(route('roles.create')); ?> " class="bg-slate-700 text-sm rounded-md text-white px-3 py-3" >Create</a>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\ACI\Desktop\role\Role and permission\resources\views/roles/list.blade.php ENDPATH**/ ?>