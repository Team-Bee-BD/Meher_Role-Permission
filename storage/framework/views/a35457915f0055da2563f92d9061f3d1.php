         ...
         <table class="w-full">
            ...
            <tbody class="bg-white">
                <?php if($users->isNotEmpty()): ?>
                 ...
                 <tr class="border-b">
                    <td class="px-6 py-3 text-left"><?php echo e($user->id); ?></td>
                    <td class="px-6 py-3 text-left"><?php echo e($user->name); ?></td>
                    <td class="px-6 py-3 text-left"><?php echo e($user->email); ?></td>
                    <td class="px-6 py-3 text-left"><?php echo e($user->roles->pluck('name')->implode(' ,')); ?></td>
                    <td class="px-6 py-3 text-left"><?php echo e(\Carbon\Carbon::parse($user->created_at) ->format('d M, Y')); ?></td>
...
<?php endif; ?>
<?php /**PATH C:\Users\ACI\Desktop\role\Role and permission\resources\views/users/list.blade.php ENDPATH**/ ?>