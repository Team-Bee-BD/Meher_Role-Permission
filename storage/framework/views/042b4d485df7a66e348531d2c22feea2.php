...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between">
            ...
            <a href="<?php echo e(route('articles.create')); ?> " class="bg-slate-700 text-sm rounded-md  text-white px-3 py-3" style="text-decoration: btn " >Create</a>
        </div>
         ...
         <table class="w-full">
            ...
            <tbody class="bg-white">
                <?php if($articles->isNotEmpty()): ?>
                 ...
                 <tr class="border-b">
                    <td class="px-6 py-3 text-left"><?php echo e($article->id); ?></td>
                    <td class="px-6 py-3 text-left"><?php echo e($article->title); ?></td>
                    <td class="px-6 py-3 text-left"><?php echo e($article->content); ?></td>
                    <td class="px-6 py-3 text-left"><?php echo e($article->author); ?></td>
                    <td class="px-6 py-3 text-left"><?php echo e(\Carbon\Carbon::parse($article->created_at) ->format('d M, Y')); ?></td>
                    <td class="px-6 py-3 text-center"> 
                         <a href="javascript:void(0);"onclick ="deletearticles(<?php echo e($article->id); ?>)" class="bg-red-600 text-sm rounded-md text-white px-3 py-3 hover:bg-red-500" >Delete</a>
                  </td>
                </tr> 
...
<?php endif; ?>
<?php /**PATH C:\Users\ACI\Desktop\role\Role and permission\resources\views/articles/list.blade.php ENDPATH**/ ?>