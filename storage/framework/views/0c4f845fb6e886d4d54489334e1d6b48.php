...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between">
            ...
            <a href="<?php echo e(route('permission.create')); ?> " class="bg-slate-700 text-sm rounded-md  text-dark px-3 py-3" style="text-decoration: btn " >Create</a>
        </div>
                ...
                <?php if($permissions->isNotEmpty()): ?>
                 ...
                 <tr class="border-b">
                    ...
                    <td class="px-6 py-3 text-center"> 
                         <a href="javscript:void(0);"onclick ="deletePermission(<?php echo e($permission->id); ?>)" class="bg-red-600 text-sm rounded-md text-white px-3 py-3 hover:bg-red-500" >Delete</a>
                  </td>
                </tr> 
...
<?php endif; ?>
<?php /**PATH C:\Users\ACI\Desktop\practice\project\resources\views/permission/list.blade.php ENDPATH**/ ?>